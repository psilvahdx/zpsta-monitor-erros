		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#portosegurozpstamonitor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"portosegurozpstamonitor-display": {
								"semanticObject": "portosegurozpstamonitor",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=portoseguro.zpstamonitor",
									"url": sap.ui.require.toUrl("portoseguro/zpstamonitor")
								}
							}
						}
					}
